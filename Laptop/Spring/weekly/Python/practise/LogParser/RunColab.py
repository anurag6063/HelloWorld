...
Original file is located at
    https://colab.research.google.com/drive/1p1JsI8xWiiaI7RcT7XSkA8uNtAvhD7nG
"""
...
training_sentences = sentences[0:1000]

testing_sentences = sentences[1001:1500]
...
X_train_gen = ((dict_vectorizer.transform(X_train[i]) ) for i in range(80637) )
...
for x in X_train_gen:
  X_train_list.extend(list(x))
