# -*- coding: utf-8 -*-
"""
Created on Tue Jan 29 12:25:13 2019
...
def json_example():
   ...
   #boolean_test = req_data['boolean_test']
    ...
    if 'indiv_id' in req_data:
        ...
        res = es.search(index="es_fraud_detect_v3", body={"query":{"bool":{"must":[{"match":{"indv_id":indivId}},{"match":{"case_num":caseNo}}]}}})
    else:
        res = es.search(index="es_fraud_detect_v3", body={"query":{"bool":{"must":[{"match":{"case_num":caseNo}}]}}})
